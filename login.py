...
#________________Lista entrada nome e senha NOVOS

credenciais_novo_nome =[]
credenciais_nova_senha =[]

test = set(credenciais_novo_nome+credenciais_nova_senha + entrada_cred_nome + entrada_cred_nome)
...
def botao_entrada():
    ...
    if  entra_nome and entra_senha   in test :
